...
export async function getSettings() {
  const settings: Setting[] = [
    {
      name: 'app_name',
      title: 'App Name',
      placeholder: 'Stable Audio Generator',
      type: 'text',
      group: 'appinfo',
      tab: 'general',
    },
    {
      ...
      placeholder:
        'Create high-quality music and sound ideas with Stable Audio 3.0.',
      type: 'textarea',
      group: 'appinfo',
      tab: 'general',
    },
  ...
  "premium-yearly": "prod_xxx"
    ...
    },
    {
      ...
      type: 'text',
      placeholder: 'stable-audio.example',
      group: 'plausible',
      tab: 'analytics',
    },
    {
    ...
    },
    {
      ...
      type: 'text',
      placeholder:
        'Stable Audio Generator <no-reply@mail.stable-audio.example>',
      group: 'resend',
      tab: 'email',
    },
    {
    ...
    },
    {
      ...
      placeholder: 'sk-xxx',
      group: 'stability',
      tip: 'Stability AI API key for Stable Audio 3.0',
      tab: 'ai',
    },
    {
      name: 'kie_api_key',
