...
const defaultPermissions = [
  ...
  // SEO copy management
  {
    code: 'admin.seo-copy.read',
    resource: 'seo-copy',
    action: 'read',
    title: 'Read SEO Copy',
    description: 'View SEO copy configuration',
  },
  {
    code: 'admin.seo-copy.write',
    resource: 'seo-copy',
    action: 'write',
    title: 'Write SEO Copy',
    description: 'Update SEO copy configuration',
  },
...
const defaultRoles = [
  ...
  },
  {
    name: 'seo_editor',
    title: 'SEO Editor',
    description: 'SEO copy editor with access to copy configuration',
    status: 'active',
    sort: 4,
    permissions: [
      'admin.access',
      'admin.seo-copy.read',
      'admin.seo-copy.write',
    ],
  },
  {
    name: 'viewer',
